...
CREATE SEQUENCE trainees_id_seq INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE trainers_id_seq INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE trainees_to_trainers_id_seq INCREMENT BY 1 START WITH 1;
