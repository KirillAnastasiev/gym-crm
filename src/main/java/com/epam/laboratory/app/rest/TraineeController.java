...
class TraineeController {
    ...
    @PutMapping(path = "/{username}/trainers", consumes = "application/json", produces = "application/json")
    Collection<TrainerDto> updateTraineeTrainers(@PathVariable String username,
                                                 @RequestBody Collection<TrainerDto> trainerDtoCollection) {
        var trainers = trainerDtoCollection.stream()
